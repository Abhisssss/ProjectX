...
class Department(models.Model):
    ...
    dept_id = models.CharField(max_length = 100,primary_key = True)
...
class Student(models.Model):
    ...
    dept_id = models.ForeignKey(Department)
    sem = models.IntegerField()
    group_id = models.ForeignKey(Classroom)
    person_id = models.CharField(max_length = 100)

    class Meta:
        unique_together = ("student_usn", "person_id")
...
class faces(models.Model):
    ...
    person_id = models.ForeignKey(Student)
